...
> ⚠️ **v1 유산 문서 (2026-09-20).** 「전국 보조금 정보 사이트」(v2)는 독자를 국적・재류자격과 무관한 일반 주민 전반으로 재정의했다(`docs/00_MASTER_PLAN.md` v2 §3). 「외국인 독자 대응」이라는 본 문서의 전제 자체가 v2와 맞지 않으므로 폐기 대상 — 다국어화가 다시 필요해지면 새 전제로 재작성한다.
