...
/**
 * 計測タグ（GA4 / Microsoft Clarity / Google AdSense）
 *   - ID は siteConfig.analytics（= NEXT_PUBLIC_GA4_ID / NEXT_PUBLIC_CLARITY_ID / NEXT_PUBLIC_ADSENSE_CLIENT）から取得
...
export function Analytics() {
  ...
  const { ga4, clarity, adsense } = siteConfig.analytics;
  if (!ga4 && !clarity && !adsense) return null;
