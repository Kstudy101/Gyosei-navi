...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "また、バリューコマース株式会社のアフィリエイトサービスを利用し、じゃらん・大丸松坂屋オンラインショッピング等の提携広告主のサービスを紹介する場合があります。リンク経由の成果に応じて報酬が支払われることがあり、その際バリューコマース側で Cookie 等を用いたアクセス情報の取得が行われる場合があります。",
    ],
  },
  {
