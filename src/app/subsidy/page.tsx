...
export default function SubsidyIndexPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">補助金を探す</h1>
      <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">目的別に、全国の補助金・助成金をわかりやすく解説します。</p>
