...
> 명칭 이력: 2026-08-17 行政タイムズ안 검토 후 원안 유지로 확정
...
**Phase 0 — 基盤構築 (2026.08~09) — 완료** (최종 점검 2026-08-23)
- [x] 사이트명·도메인 확정 — https://gyosei-navi.jp (Xserver 배포, 가동 중)
- [x] Next.js 초기화 + 렌더링 파이프라인 — 정적 export 91 HTML + Pagefind 색인
- [x] 신뢰 페이지(運営者情報·免責事項·プライバシーポリシー)
- [x] 런칭 기사 8건 (永住ガイドライン改定 특집)
- [x] ⏰ 퍼블릭코멘트 기사 — 2026-08-17 발행 (마감 2026-09-04 대비 완료)

**진척**: 기사 61건 published (Month 1〜4 = #1〜#37 전건) / 도구 `/tools/visa-navi`·`/tools/eiju-shindan` 가동 /
감시 자동화 5개 워크플로 + changedetection 11건.

**다음**: Month 5 이후 콘텐츠 캘린더 수립 (`docs/05_CONTENT_CALENDAR.md` 가 Month 4 에서 끝남).
미해결 인프라 항목은 `docs/07_COMPLETION_REPORT.md` 말미 표 참조 (현재 e-Stat appId 발급 1건).
